...
class SabGestureDetector extends StatefulWidget {
  ...
  @override
  State<SabGestureDetector> createState() => _SabGestureDetectorState();
}

class _SabGestureDetectorState extends State<SabGestureDetector> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: !F.flavor.isLive && showHitBox
          ? Stack(
